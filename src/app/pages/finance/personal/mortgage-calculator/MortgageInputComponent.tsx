...
export function MortgageInputComponent(x: Mortgage) {
  ...
  return (
    <Form>
      <FormGroup className={'mb-3'} controlId={'formMortgageAmount'}>
        ...
        <InputGroup>
          ...
          <FormControl
            ...
            onChange={(e) => {
              x.updateAmount
                ? x.updateAmount(e.target.value)
                : logSilentUpdate('amount')
            }}
          />
        </InputGroup>
      </FormGroup>
      <FormGroup className={'mb-3'}>
        <FormLabel htmlFor={'downPaymentAmount'}>Down payment amount</FormLabel>
        <InputGroup>
          <InputGroupText>$</InputGroupText>
          <FormControl
            type={'number'}
            ...
            onChange={(e) => {
              x.updatePaymentAmount
                ? x.updatePaymentAmount(e.target.value)
                : logSilentUpdate('downPaymentAmount')
            }}
          />
        </InputGroup>
      </FormGroup>
      <FormGroup className={'mb-3'}>
        ...
        <InputGroup>
          <FormControl
            ...
            onChange={(e) => {
              x.updatePaymentPercentage
                ? x.updatePaymentPercentage(e.target.value)
                : logSilentUpdate('downPaymentPercentage')
            }}
          />
          <InputGroupText>%</InputGroupText>
        </InputGroup>
      ...
      <FormGroup className={'mb-3'}>
        <FormLabel htmlFor={'formLoanTerm'}>Loan term</FormLabel>
        <InputGroup>
          <FormSelect
            id={'formLoanTerm'}
            value={x.term}
            onChange={(e) => {
              x.updateTerm
                ? x.updateTerm(e.target.value)
                : logSilentUpdate('term')
            }}
          >
      ...
      <FormGroup className={'mb-3'} controlId={'formInterestRate'}>
        ...
        <InputGroup>
          <FormControl
            ...
            placeholder={'0'}
            onChange={(e) => {
              x.updateInterestRate
                ? x.updateInterestRate(e.target.value)
                : logSilentUpdate('interestRage')
            }}
          />
          <InputGroupText>%</InputGroupText>
        </InputGroup>
      ...
      {Features.ZipcodeTaxLookup.enabled && (
        <FormGroup className={'mb-3'} controlId={'formZipCode'}>
          ...
          <FormControl
            ...
            onChange={(e) => {
              x.updateZipcode
                ? x.updateZipcode(e.target.value)
                : logSilentUpdate('zipCode')
            }}
          />
        </FormGroup>
      )}
        ...
        <>
          <FormGroup className={'mb-3'} controlId={'formCreditScore'}>
            ...
            <FormSelect
              ...
              onChange={(e) => {
                x.updateCreditScore
                  ? x.updateCreditScore(e.target.value)
                  : logSilentUpdate('creditScore')
              }}
            >
          ...
          <FormGroup className={'mb-3'} controlId={'formPropertyTaxes'}>
            <FormLabel>Property taxes per month</FormLabel>
            <InputGroup>
              <InputGroupText>$</InputGroupText>
              <FormControl
                type={'number'}
                ...
                onChange={(e) => {
                  x.updatePropertyTax
                    ? x.updatePropertyTax(e.target.value)
                    : logSilentUpdate('propertyTax')
                }}
              />
            </InputGroup>
          </FormGroup>
          <FormGroup className={'mb-3'} controlId={'formHomeownersInsurance'}>
            <FormLabel>Homeowner&apos;s insurance per month</FormLabel>
            <InputGroup>
              <InputGroupText>$</InputGroupText>
              <FormControl
                type={'number'}
                value={x.homeOwnersInsurance}
                placeholder={'0'}
                onChange={(e) => {
                  x.updateHomeOwnersInsurance
                    ? x.updateHomeOwnersInsurance(e.target.value)
                    : logSilentUpdate('homeOwnersInsurance')
                }}
              />
            </InputGroup>
          </FormGroup>
          <FormGroup className={'mb-3'} controlId={'formMortgagePMI'}>
            <FormLabel>Private Mortgage Insurance(PMI) per month</FormLabel>
            <InputGroup>
              <InputGroupText>$</InputGroupText>
              <FormControl
                type={'number'}
          ...
          <FormGroup className={'mb-3'} controlId={'formMortgageHOA'}>
            ...
            <InputGroup>
              ...
              <FormControl
                ...
                onChange={(e) => {
                  x.updateHoaFees
                    ? x.updateHoaFees(e.target.value)
                    : logSilentUpdate('hoaFees')
                }}
              />
            </InputGroup>
          </FormGroup>
          <FormGroup className={'mb-3'} controlId={'formExtraPayment'}>
            <FormLabel>Extra monthly principle payment amount</FormLabel>
            <InputGroup>
              <InputGroupText>$</InputGroupText>
              <FormControl
                type={'number'}
                ...
                placeholder={'0'}
                onChange={(e) => {
                  x.updateExtraPayment
                    ? x.updateExtraPayment(e.target.value)
                    : logSilentUpdate('extraPayment')
                }}
              />
            </InputGroup>
          </FormGroup>
