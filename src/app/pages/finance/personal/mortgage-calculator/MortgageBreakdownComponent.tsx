        ...
        datasets: [
            {
                label:
                    '$ ' +
                    numberToTwoDecimalPlaces(monthlyPayment.total) +
                    ' /mth',
                data: values,
                        ...
                        {data.datasets[0].data.map((dataset, i) => {
                            return (
                                <ListGroupItem
                                    className={'mt-2'}
                                    size="lg"
                                    key={'list_group_item_' + i}
                                >
                                    <InputGroup>
                                        <InputGroupText
                                            className={`w-5 m-2 rounded-full border-[${data.datasets[0].backgroundColor[i]} bg-[${data.datasets[0].backgroundColor[i]}]`}
                                        ></InputGroupText>
                                        <InputGroupText>
                                            {data.labels[i]}
                                        </InputGroupText>
