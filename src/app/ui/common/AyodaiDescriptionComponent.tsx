...
export function AyodaiDescriptionComponent(){
    return (
        <Container className={'p-3'}>
            <Card style={{maxWidth: '50rem'}} className={'m-auto'}>
                ...
                <CardFooter>
                    <div className={'text-center'}>
                        ...
                        Vanderpuye</Link> to break goals into chunks and plan actionable items for personal development.
                        And the underlying goal for this project is to expand my knowledge of React + Typescript + Github while
